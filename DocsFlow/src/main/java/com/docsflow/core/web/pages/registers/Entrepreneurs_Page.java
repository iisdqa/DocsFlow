...
public class Entrepreneurs_Page extends WebPage<Entrepreneurs_Page> 
{
	private static final String PAGE_URL = BASE_URL + "/Dictionaries/DictionariesUDB/List";
	
	public Entrepreneurs_Page(WebDriver driver) 
	{
		super(driver);
	}

	@Override
	public Entrepreneurs_Page load()
	{
		driver.get(PAGE_URL);
		return this;
	}
	...
	public Entrepreneurs_RegPage cardAdd_Call()
	{
	...
	// Поиск карточки
		...
		public Entrepreneurs_RegPage card_Edit()
		{
		...
		public Entrepreneurs_RegPage card_View()
		{
